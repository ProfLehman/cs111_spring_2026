...
**Spring 2026**
**Section X1 - Arizona (On-Line)**   

<img src="CS111_Logo.png" alt="CS 111 Logo" width="200">
...
This course is **online** and **asynchronous**. There are no required in-person class meetings and no regularly scheduled live (synchronous) class sessions.

Course content is delivered through weekly readings, videos, and assignments posted in Moodle. Students are expected to engage with course materials throughout the week and complete all assignments by the posted deadlines. **All deadlines are published using Indiana (Eastern) Time**, unless otherwise noted. Moodle system should automatically adjust to the correct AZ time.

Occasional **optional live review and help sessions** may be offered to support student learning. Attendance at these sessions is not required. Additional short help or clarification videos may be posted in response to student questions.

Students are strongly encouraged to contact the instructor when they have questions, utilize on-line office hours, and schedule Zoom meetings when needed.

For most weeks, course content and assignments will be posted about **10 days in advance**, giving students two weekends to work on assignments.
...
Exams are **closed notes**. Review topics and sample questions are provided. All exams are online and require Respondus browser and a web camera. 

- **Exam #1: February 9 to 15 (On-line via Respondus Browser)**
- **Exam #2: March 23 to 29 (On-line via Respondus Browser)**
- **Final Exam: April 27 to 30 (On-line via Respondus Browser)**

> The schedule may change slightly. Check the course website for updates.

### Weekly Schedule

| Week | Week Begins | Week Ends | Topics                               |
|------|-------------|-----------|--------------------------------------|
| 1    | Jan-12      | Jan-18    | Welcome, History, Binary             |
| 2    | Jan-19      | Jan-25    | Hex, ASCII, Compression              |
| 3    | Jan-26      | Feb-01    | Logic, Hardware                      |
| 4    | Feb-02      | Feb-08    | Review                               |
| 5    | Feb-09      | Feb-15    | **Exam #1**, Operating Systems, Files    |
| 6    | Feb-16      | Feb-22    | Cloud Apps, Spreadsheets             |
| 7    | Feb-23      | Mar-01    | Networking, Web (HTML, CSS)          |
| 8    | Mar-02      | Mar-08    | **Spring Break**                         |
| 9    | Mar-09      | Mar-15    | Security, AI                         |
| 10   | Mar-16      | Mar-22    | Review, Ethical Issues               |
| 11   | Mar-23      | Mar-29    | **Exam #2**, Programming (Python)        |
| 12   | Mar-30      | Apr-05    | Planning (IPO), Input/Output         |
| 13   | Apr-06      | Apr-12    | Selection (if)                       |
| 14   | Apr-13      | Apr-19    | Repetition (loops, lists)            |
| 15   | Apr-20      | Apr-26    | Debugging, API’s                     |
| 16   | Apr-27      | Apr-30    | **Final Exam**                           |


---

*Last modified: Friday, January 9, 2026*
